      ...
      <div className="flex lg:flex-row flex-col items-center justify-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
        <div className="bg-secondaryColor p-3 flex flex-0.7 w-full">
          <div className="flex flex-col justify-center items-center border-2 border-dotted border-gray-300 p-3 w-full h-420">
            {loading && <Spinner />}
            {wrongImageType && <p>Please add a correct image format</p>}
            {!imageAsset ? (
              <label>
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  <p className="mt-32 text-gray-400">
                    Use high quality JPG,SVG,GIF or PNG less than 20MB{" "}
                  </p>
                </div>
                <input
                  type="file"
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          <input
            ...
            placeholder="Add a destination link if applicable😉"
            className="outline-none text-base sm:text-lg font-bold border-b-2 border-gray-200 p-2"
          />
          <div className="flex flex-col">
            ...
            >
              ...
              {categories.map((category) => (
                <option
                  className="text-base border-0 capitalize outline-none bg-white text-black"
                  value={category.name}
                >
                  {category.name}
                </option>
